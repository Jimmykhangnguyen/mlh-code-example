...
const ConnectionCard = ({ connections, checkFunction }) => {
    ...
    return (
        <div style={{ scrollbarGutter: 'stable', scrollbarWidth: "thin"}} className="bg-[#FCAF58] rounded-[20px] w-[50vh] h-[94vh] m-[2vh] mt-[0vh] ml-[0vh] flex flex-col items-center overflow-auto overflow-x-hidden">
            <button
